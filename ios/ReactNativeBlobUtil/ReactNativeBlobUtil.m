...
#pragma mark - fs.releaseReadStream
RCT_EXPORT_METHOD(releaseReadStream) {
    [ReactNativeBlobUtilFS releaseReadStream];
}
#pragma mark - fs.closeReadStream
RCT_EXPORT_METHOD(closeReadStream) {
    [ReactNativeBlobUtilFS closeReadStream];
}
